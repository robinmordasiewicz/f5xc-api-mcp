...
```bash
# Create/Update
f5xcctl observability create log -n <namespace> -i log.yaml

# Get
f5xcctl observability get log <name> -n <namespace>

# List
f5xcctl observability list log -n <namespace>

# Delete
f5xcctl observability delete log <name> -n <namespace>
```
