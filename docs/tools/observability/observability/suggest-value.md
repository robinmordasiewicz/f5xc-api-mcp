...
```bash
# Create/Update
f5xcctl observability create suggest_value -n <namespace> -i suggest_value.yaml

# Get
f5xcctl observability get suggest_value <name> -n <namespace>

# List
f5xcctl observability list suggest_value -n <namespace>

# Delete
f5xcctl observability delete suggest_value <name> -n <namespace>
```
