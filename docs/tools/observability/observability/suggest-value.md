...
```bash
# Create/Update
xcsh observability create suggest_value -n <namespace> -i suggest_value.yaml

# Get
xcsh observability get suggest_value <name> -n <namespace>

# List
xcsh observability list suggest_value -n <namespace>

# Delete
xcsh observability delete suggest_value <name> -n <namespace>
```
