...
```bash
# Create/Update
f5xcctl configuration create tls_report_summary -n <namespace> -i tls_report_summary.yaml

# Get
f5xcctl configuration get tls_report_summary -n <namespace> <name>

# List
f5xcctl configuration list tls_report_summary -n <namespace>

# Delete
f5xcctl configuration delete tls_report_summary -n <namespace> <name>
```
