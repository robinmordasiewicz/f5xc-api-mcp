...
```bash
# Create/Update
xcsh observability create scroll -n <namespace> -i scroll.yaml

# Get
xcsh observability get scroll <name> -n <namespace>

# List
xcsh observability list scroll -n <namespace>

# Delete
xcsh observability delete scroll <name> -n <namespace>
```
