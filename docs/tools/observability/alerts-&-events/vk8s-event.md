...
```bash
# Create/Update
xcsh observability create vk8s_event -n <namespace> -i vk8s_event.yaml

# Get
xcsh observability get vk8s_event <name> -n <namespace>

# List
xcsh observability list vk8s_event -n <namespace>

# Delete
xcsh observability delete vk8s_event <name> -n <namespace>
```
