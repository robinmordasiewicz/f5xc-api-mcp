...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-voltshare-admin-policy-create` | Create VoltShare Admin Policy |
| `f5xc-api-core-voltshare-admin-policy-get` | Get VoltShare Admin Policy |
| `f5xc-api-core-voltshare-admin-policy-list` | List VoltShare Admin Policy |
| `f5xc-api-core-voltshare-admin-policy-update` | Replace VoltShare Admin Policy |
| `f5xc-api-core-voltshare-admin-policy-delete` | Delete VoltShare Admin Policy |
...
```bash
# Create/Update
f5xcctl apply -f voltshare_admin_policy.yaml

# Get
f5xcctl get voltshare_admin_policy {name} -n {namespace}

# List
f5xcctl get voltshare_admin_policys -n {namespace}

# Delete
f5xcctl delete voltshare_admin_policy {name} -n {namespace}
```
