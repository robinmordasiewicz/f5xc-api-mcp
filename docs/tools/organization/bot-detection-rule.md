...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-bot-detection-rule-create` | Deploy Bot Detection Rules |
| `f5xc-api-core-bot-detection-rule-get` | Get Bot Detection Rule |
| `f5xc-api-core-bot-detection-rule-list` | List Bot Detection Rule |
...
```bash
# Create/Update
f5xcctl apply -f bot_detection_rule.yaml

# Get
f5xcctl get bot_detection_rule {name} -n {namespace}

# List
f5xcctl get bot_detection_rules -n {namespace}

# Delete
f5xcctl delete bot_detection_rule {name} -n {namespace}
```
