...
```bash
# Create/Update
f5xcctl apply -f update_asn_prefix_review_statu.yaml

# Get
f5xcctl get update_asn_prefix_review_statu {name} -n {namespace}

# List
f5xcctl get update_asn_prefix_review_status -n {namespace}

# Delete
f5xcctl delete update_asn_prefix_review_statu {name} -n {namespace}
```
