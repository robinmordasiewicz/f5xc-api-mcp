...
```bash
# Create/Update
f5xcctl apply -f activation_statu.yaml

# Get
f5xcctl get activation_statu {name} -n {namespace}

# List
f5xcctl get activation_status -n {namespace}

# Delete
f5xcctl delete activation_statu {name} -n {namespace}
```
