...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-local-kubeconfig-create` | Create K8s Cluster Local Kube Config |
| `f5xc-api-core-local-kubeconfig-get` | List Local Kube Configs |
...
```bash
# Create/Update
f5xcctl apply -f local_kubeconfig.yaml

# Get
f5xcctl get local_kubeconfig {name} -n {namespace}

# List
f5xcctl get local_kubeconfigs -n {namespace}

# Delete
f5xcctl delete local_kubeconfig {name} -n {namespace}
```
