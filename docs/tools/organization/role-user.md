...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-role-user-create` | Assign role to User |
...
```bash
# Create/Update
f5xcctl apply -f role_user.yaml

# Get
f5xcctl get role_user {name} -n {namespace}

# List
f5xcctl get role_users -n {namespace}

# Delete
f5xcctl delete role_user {name} -n {namespace}
```
