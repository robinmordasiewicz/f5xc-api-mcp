...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-unset-update` | Unset admin ntfn preference |
...
```bash
# Create/Update
f5xcctl apply -f unset.yaml

# Get
f5xcctl get unset {name} -n {namespace}

# List
f5xcctl get unsets -n {namespace}

# Delete
f5xcctl delete unset {name} -n {namespace}
```
