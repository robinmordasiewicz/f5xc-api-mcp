...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-reset-create` | Reset password |
...
```bash
# Create/Update
f5xcctl apply -f reset.yaml

# Get
f5xcctl get reset {name} -n {namespace}

# List
f5xcctl get resets -n {namespace}

# Delete
f5xcctl delete reset {name} -n {namespace}
```
