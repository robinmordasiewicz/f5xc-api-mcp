...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-app-create` | Top Latency Overview Apps |
...
```bash
# Create/Update
f5xcctl apply -f app.yaml

# Get
f5xcctl get app {name} -n {namespace}

# List
f5xcctl get apps -n {namespace}

# Delete
f5xcctl delete app {name} -n {namespace}
```
