...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-get-dns-info-get` | Get DNS Info |
...
```bash
# Create/Update
f5xcctl apply -f get_dns_info.yaml

# Get
f5xcctl get get_dns_info {name} -n {namespace}

# List
f5xcctl get get_dns_infos -n {namespace}

# Delete
f5xcctl delete get_dns_info {name} -n {namespace}
```
