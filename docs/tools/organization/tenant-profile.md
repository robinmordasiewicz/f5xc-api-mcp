...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-tenant-profile-create` | Create Tenant Profile |
| `f5xc-api-core-tenant-profile-get` | Get Tenant Profile |
| `f5xc-api-core-tenant-profile-list` | List Tenant Profile |
| `f5xc-api-core-tenant-profile-update` | Replace Tenant Profile |
| `f5xc-api-core-tenant-profile-delete` | Delete Tenant Profile |
