...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-tax-exempt-request-create` | Tax exemption verification request |
...
```bash
# Create/Update
f5xcctl apply -f tax_exempt_request.yaml

# Get
f5xcctl get tax_exempt_request {name} -n {namespace}

# List
f5xcctl get tax_exempt_requests -n {namespace}

# Delete
f5xcctl delete tax_exempt_request {name} -n {namespace}
```
