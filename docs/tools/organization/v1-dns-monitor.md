...
```bash
# Create/Update
f5xcctl apply -f v1_dns_monitor.yaml

# Get
f5xcctl get v1_dns_monitor {name} -n {namespace}

# List
f5xcctl get v1_dns_monitors -n {namespace}

# Delete
f5xcctl delete v1_dns_monitor {name} -n {namespace}
```
