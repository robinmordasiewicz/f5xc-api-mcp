...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-to-event-update` | Link Alert to Event |
...
```bash
# Create/Update
f5xcctl apply -f to_event.yaml

# Get
f5xcctl get to_event {name} -n {namespace}

# List
f5xcctl get to_events -n {namespace}

# Delete
f5xcctl delete to_event {name} -n {namespace}
```
