...
```bash
# Create/Update
f5xcctl apply -f evaluate_api_acces.yaml

# Get
f5xcctl get evaluate_api_acces {name} -n {namespace}

# List
f5xcctl get evaluate_api_access -n {namespace}

# Delete
f5xcctl delete evaluate_api_acces {name} -n {namespace}
```
