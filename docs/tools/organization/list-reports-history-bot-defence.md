...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-list-reports-history-bot-defence-create` | List Reports History Bot Defence |
...
```bash
# Create/Update
f5xcctl apply -f list_reports_history_bot_defence.yaml

# Get
f5xcctl get list_reports_history_bot_defence {name} -n {namespace}

# List
f5xcctl get list_reports_history_bot_defences -n {namespace}

# Delete
f5xcctl delete list_reports_history_bot_defence {name} -n {namespace}
```
