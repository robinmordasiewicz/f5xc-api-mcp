...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-dos-automitigation-rule-get` | Get DoS Auto-Mitigation Rules for CDN Load Balancer |
| `f5xc-api-core-dos-automitigation-rule-delete` | Delete DoS Auto-Mitigation Rule for CDN Load Balancer |
