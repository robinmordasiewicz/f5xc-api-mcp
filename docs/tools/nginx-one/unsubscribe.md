...
```bash
# Create/Update
xcsh nginx_one create unsubscribe -n <namespace> -i unsubscribe.yaml

# Get
xcsh nginx_one get unsubscribe <name> -n <namespace>

# List
xcsh nginx_one list unsubscribe -n <namespace>

# Delete
xcsh nginx_one delete unsubscribe <name> -n <namespace>
```
