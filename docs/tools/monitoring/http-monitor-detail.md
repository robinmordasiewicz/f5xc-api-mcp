...
```bash
# Create/Update
f5xcctl apply -f http_monitor_detail.yaml

# Get
f5xcctl get http_monitor_detail {name} -n {namespace}

# List
f5xcctl get http_monitor_details -n {namespace}

# Delete
f5xcctl delete http_monitor_detail {name} -n {namespace}
```
