...
| Tool | Description |
|------|-------------|
| `f5xc-api-waap-metric-create` | Metrics |
...
```bash
# Create/Update
f5xcctl apply -f metric.yaml

# Get
f5xcctl get metric {name} -n {namespace}

# List
f5xcctl get metrics -n {namespace}

# Delete
f5xcctl delete metric {name} -n {namespace}
```
