...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-segment-connection-get` | Get segment connector |
| `f5xc-api-core-segment-connection-list` | List Segment Connector |
| `f5xc-api-core-segment-connection-update` | Replace segment connector |
