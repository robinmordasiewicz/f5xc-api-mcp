...
```bash
# Create/Update
xcsh service_mesh create metric -n <namespace> -i metric.yaml

# Get
xcsh service_mesh get metric <name> -n <namespace>

# List
xcsh service_mesh list metric -n <namespace>

# Delete
xcsh service_mesh delete metric <name> -n <namespace>
```
