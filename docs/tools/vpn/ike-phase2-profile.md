...
```bash
# Create/Update
f5xcctl vpn create ike_phase2_profile -n <namespace> -i ike_phase2_profile.yaml

# Get
f5xcctl vpn get ike_phase2_profile <name> -n <namespace>

# List
f5xcctl vpn list ike_phase2_profile -n <namespace>

# Delete
f5xcctl vpn delete ike_phase2_profile <name> -n <namespace>
```
