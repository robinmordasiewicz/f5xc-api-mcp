...
```bash
# Create/Update
f5xcctl apply -f ike_phase2_profile.yaml

# Get
f5xcctl get ike_phase2_profile {name} -n {namespace}

# List
f5xcctl get ike_phase2_profiles -n {namespace}

# Delete
f5xcctl delete ike_phase2_profile {name} -n {namespace}
```
