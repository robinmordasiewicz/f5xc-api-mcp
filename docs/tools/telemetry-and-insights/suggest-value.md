...
```bash
# Create/Update
f5xcctl telemetry_and_insights create suggest_value -n <namespace> -i suggest_value.yaml

# Get
f5xcctl telemetry_and_insights get suggest_value <name> -n <namespace>

# List
f5xcctl telemetry_and_insights list suggest_value -n <namespace>

# Delete
f5xcctl telemetry_and_insights delete suggest_value <name> -n <namespace>
```
