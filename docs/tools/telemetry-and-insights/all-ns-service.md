...
```bash
# Create/Update
xcsh telemetry_and_insights create all_ns_service -n <namespace> -i all_ns_service.yaml

# Get
xcsh telemetry_and_insights get all_ns_service <name> -n <namespace>

# List
xcsh telemetry_and_insights list all_ns_service -n <namespace>

# Delete
xcsh telemetry_and_insights delete all_ns_service <name> -n <namespace>
```
