...
```bash
# Create/Update
f5xcctl telemetry_and_insights create all_ns_service -n <namespace> -i all_ns_service.yaml

# Get
f5xcctl telemetry_and_insights get all_ns_service <name> -n <namespace>

# List
f5xcctl telemetry_and_insights list all_ns_service -n <namespace>

# Delete
f5xcctl telemetry_and_insights delete all_ns_service <name> -n <namespace>
```
