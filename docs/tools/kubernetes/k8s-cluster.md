...
| Tool | Description |
|------|-------------|
| `f5xc-api-appstack-k8s-cluster-create` | Create Configuration Specification |
| `f5xc-api-appstack-k8s-cluster-get` | Get Configuration Specification |
| `f5xc-api-appstack-k8s-cluster-list` | List K8s Cluster |
| `f5xc-api-appstack-k8s-cluster-update` | Replace Configuration Specification |
...
```bash
# Create/Update
f5xcctl apply -f k8s_cluster.yaml

# Get
f5xcctl get k8s_cluster {name} -n {namespace}

# List
f5xcctl get k8s_clusters -n {namespace}

# Delete
f5xcctl delete k8s_cluster {name} -n {namespace}
```
