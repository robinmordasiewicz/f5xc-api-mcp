...
| Tool | Description |
|------|-------------|
| `f5xc-api-shapesecurity-alert-gen-policy-create` | Create Alert Generation Policy. |
| `f5xc-api-shapesecurity-alert-gen-policy-get` | GET Alert Generation Policy. |
| `f5xc-api-shapesecurity-alert-gen-policy-list` | List BRM Alert Generation Policy. |
| `f5xc-api-shapesecurity-alert-gen-policy-update` | Replace Alert Generation Policy. |
| `f5xc-api-shapesecurity-alert-gen-policy-delete` | DELETE BRM Alert Generation Policy. |
