...
| Tool | Description |
|------|-------------|
| `f5xc-api-shapesecurity-suggest-value-create` | Suggest Values. |
...
```bash
# Create/Update
f5xcctl shape_security create suggest_value -n <namespace> -i suggest_value.yaml

# Get
f5xcctl shape_security get suggest_value <name> -n <namespace>

# List
f5xcctl shape_security list suggest_value -n <namespace>

# Delete
f5xcctl shape_security delete suggest_value <name> -n <namespace>
```
