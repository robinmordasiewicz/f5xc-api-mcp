...
```bash
# Create/Update
f5xcctl apply -f protected_application.yaml

# Get
f5xcctl get protected_application {name} -n {namespace}

# List
f5xcctl get protected_applications -n {namespace}

# Delete
f5xcctl delete protected_application {name} -n {namespace}
```
