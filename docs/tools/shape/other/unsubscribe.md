...
```bash
# Create/Update
xcsh shape create unsubscribe -n <namespace> -i unsubscribe.yaml

# Get
xcsh shape get unsubscribe <name> -n <namespace>

# List
xcsh shape list unsubscribe -n <namespace>

# Delete
xcsh shape delete unsubscribe <name> -n <namespace>
```
