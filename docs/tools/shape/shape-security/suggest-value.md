...
```bash
f5xcctl shape suggest-value create -f {file}.yaml
```
...
```bash
f5xcctl shape suggest-value create {name} --namespace {namespace}
```
...
```bash
# Create/Update
f5xcctl shape create suggest_value -n <namespace> -i suggest_value.yaml

# Get
f5xcctl shape get suggest_value <name> -n <namespace>

# List
f5xcctl shape list suggest_value -n <namespace>

# Delete
f5xcctl shape delete suggest_value <name> -n <namespace>
```
