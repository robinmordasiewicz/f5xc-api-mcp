...
```bash
f5xcctl shape bot-network-policie list --namespace {namespace}
```

List all bot-network-policies

## f5xcctl Equivalent

```bash
# Create/Update
f5xcctl shape create bot_network_policie -n <namespace> -i bot_network_policie.yaml

# Get
f5xcctl shape get bot_network_policie <name> -n <namespace>

# List
f5xcctl shape list bot_network_policie -n <namespace>

# Delete
f5xcctl shape delete bot_network_policie <name> -n <namespace>
```
