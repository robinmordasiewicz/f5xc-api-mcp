...
```bash
f5xcctl infraprotect update-advertisement-statu create -f {file}.yaml
```
...
```bash
# Create/Update
f5xcctl ddos create update_advertisement_statu -n <namespace> -i update_advertisement_statu.yaml

# Get
f5xcctl ddos get update_advertisement_statu <name> -n <namespace>

# List
f5xcctl ddos list update_advertisement_statu -n <namespace>

# Delete
f5xcctl ddos delete update_advertisement_statu <name> -n <namespace>
```
