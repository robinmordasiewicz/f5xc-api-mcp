...
```bash
f5xcctl infraprotect suggest-value create -f {file}.yaml
```
...
```bash
f5xcctl infraprotect suggest-value create {name} --namespace {namespace}
```
...
```bash
# Create/Update
f5xcctl ddos create suggest_value -n <namespace> -i suggest_value.yaml

# Get
f5xcctl ddos get suggest_value <name> -n <namespace>

# List
f5xcctl ddos list suggest_value -n <namespace>

# Delete
f5xcctl ddos delete suggest_value <name> -n <namespace>
```
