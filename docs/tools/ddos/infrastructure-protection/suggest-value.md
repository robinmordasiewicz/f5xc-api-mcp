...
```bash
# Create/Update
xcsh ddos create suggest_value -n <namespace> -i suggest_value.yaml

# Get
xcsh ddos get suggest_value <name> -n <namespace>

# List
xcsh ddos list suggest_value -n <namespace>

# Delete
xcsh ddos delete suggest_value <name> -n <namespace>
```
