...
```bash
# Create/Update
f5xcctl apply -f infraprotect_internet_prefix_advertisement.yaml

# Get
f5xcctl get infraprotect_internet_prefix_advertisement {name} -n {namespace}

# List
f5xcctl get infraprotect_internet_prefix_advertisements -n {namespace}

# Delete
f5xcctl delete infraprotect_internet_prefix_advertisement {name} -n {namespace}
```
