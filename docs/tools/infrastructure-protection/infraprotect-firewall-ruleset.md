...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-infraprotect-firewall-ruleset-get` | Get Infraprotect Firewall Ruleset |
| `f5xc-api-core-infraprotect-firewall-ruleset-list` | List Infraprotect Firewall Ruleset |
| `f5xc-api-core-infraprotect-firewall-ruleset-update` | Replace DDoS transit Firewall Ruleset |
...
```bash
# Create/Update
f5xcctl apply -f infraprotect_firewall_ruleset.yaml

# Get
f5xcctl get infraprotect_firewall_ruleset {name} -n {namespace}

# List
f5xcctl get infraprotect_firewall_rulesets -n {namespace}

# Delete
f5xcctl delete infraprotect_firewall_ruleset {name} -n {namespace}
```
