...
```bash
# Create/Update
f5xcctl infrastructure_protection create update_asn_review_statu -n <namespace> -i update_asn_review_statu.yaml

# Get
f5xcctl infrastructure_protection get update_asn_review_statu <name> -n <namespace>

# List
f5xcctl infrastructure_protection list update_asn_review_statu -n <namespace>

# Delete
f5xcctl infrastructure_protection delete update_asn_review_statu <name> -n <namespace>
```
