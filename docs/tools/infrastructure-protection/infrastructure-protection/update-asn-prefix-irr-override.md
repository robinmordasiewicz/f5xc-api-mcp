...
```bash
# Create/Update
f5xcctl infrastructure_protection create update_asn_prefix_irr_override -n <namespace> -i update_asn_prefix_irr_override.yaml

# Get
f5xcctl infrastructure_protection get update_asn_prefix_irr_override <name> -n <namespace>

# List
f5xcctl infrastructure_protection list update_asn_prefix_irr_override -n <namespace>

# Delete
f5xcctl infrastructure_protection delete update_asn_prefix_irr_override <name> -n <namespace>
```
