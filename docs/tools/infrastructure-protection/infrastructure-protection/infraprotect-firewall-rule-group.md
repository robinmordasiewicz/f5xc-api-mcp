...
```bash
# Create/Update
f5xcctl infrastructure_protection create infraprotect_firewall_rule_group -n <namespace> -i infraprotect_firewall_rule_group.yaml

# Get
f5xcctl infrastructure_protection get infraprotect_firewall_rule_group <name> -n <namespace>

# List
f5xcctl infrastructure_protection list infraprotect_firewall_rule_group -n <namespace>

# Delete
f5xcctl infrastructure_protection delete infraprotect_firewall_rule_group <name> -n <namespace>
```
