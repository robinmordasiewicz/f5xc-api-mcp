...
```bash
# Create/Update
f5xcctl infrastructure_protection create infraprotect_tunnel -n <namespace> -i infraprotect_tunnel.yaml

# Get
f5xcctl infrastructure_protection get infraprotect_tunnel <name> -n <namespace>

# List
f5xcctl infrastructure_protection list infraprotect_tunnel -n <namespace>

# Delete
f5xcctl infrastructure_protection delete infraprotect_tunnel <name> -n <namespace>
```
