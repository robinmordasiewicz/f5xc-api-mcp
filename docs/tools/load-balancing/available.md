...
f5xc.io.schema.views.api_definition.PublicConfigCustomAPI

## Tools

| Tool | Description |
|------|-------------|
| `f5xc-api-waap-available-get` | List Available API Definitions |
...
```bash
# Create/Update
f5xcctl apply -f available.yaml

# Get
f5xcctl get available {name} -n {namespace}

# List
f5xcctl get availables -n {namespace}

# Delete
f5xcctl delete available {name} -n {namespace}
```
