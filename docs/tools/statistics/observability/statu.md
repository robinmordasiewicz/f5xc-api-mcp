...
```bash
# Create/Update
f5xcctl statistics create statu -n <namespace> -i statu.yaml

# Get
f5xcctl statistics get statu <name> -n <namespace>

# List
f5xcctl statistics list statu -n <namespace>

# Delete
f5xcctl statistics delete statu <name> -n <namespace>
```
