...
```bash
# Create/Update
f5xcctl statistics create unsubscribe -n <namespace> -i unsubscribe.yaml

# Get
f5xcctl statistics get unsubscribe <name> -n <namespace>

# List
f5xcctl statistics list unsubscribe -n <namespace>

# Delete
f5xcctl statistics delete unsubscribe <name> -n <namespace>
```
