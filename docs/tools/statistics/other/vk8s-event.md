...
```bash
# Create/Update
xcsh statistics create vk8s_event -n <namespace> -i vk8s_event.yaml

# Get
xcsh statistics get vk8s_event <name> -n <namespace>

# List
xcsh statistics list vk8s_event -n <namespace>

# Delete
xcsh statistics delete vk8s_event <name> -n <namespace>
```
