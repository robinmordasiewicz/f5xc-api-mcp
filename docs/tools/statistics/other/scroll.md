...
```bash
# Create/Update
f5xcctl statistics create scroll -n <namespace> -i scroll.yaml

# Get
f5xcctl statistics get scroll <name> -n <namespace>

# List
f5xcctl statistics list scroll -n <namespace>

# Delete
f5xcctl statistics delete scroll <name> -n <namespace>
```
