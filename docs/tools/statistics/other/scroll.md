...
```bash
# Create/Update
xcsh statistics create scroll -n <namespace> -i scroll.yaml

# Get
xcsh statistics get scroll <name> -n <namespace>

# List
xcsh statistics list scroll -n <namespace>

# Delete
xcsh statistics delete scroll <name> -n <namespace>
```
