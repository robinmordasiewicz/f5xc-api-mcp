...
```bash
# Create/Update
f5xcctl statistics create firewall_log -n <namespace> -i firewall_log.yaml

# Get
f5xcctl statistics get firewall_log <name> -n <namespace>

# List
f5xcctl statistics list firewall_log -n <namespace>

# Delete
f5xcctl statistics delete firewall_log <name> -n <namespace>
```
