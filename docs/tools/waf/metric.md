...
```bash
# Create/Update
xcsh waf create metric -n <namespace> -i metric.yaml

# Get
xcsh waf get metric <name> -n <namespace>

# List
xcsh waf list metric -n <namespace>

# Delete
xcsh waf delete metric <name> -n <namespace>
```
