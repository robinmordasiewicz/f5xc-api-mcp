...
```bash
# Create/Update
f5xcctl nginx create nginx_csg -n <namespace> -i nginx_csg.yaml

# Get
f5xcctl nginx get nginx_csg <name> -n <namespace>

# List
f5xcctl nginx list nginx_csg -n <namespace>

# Delete
f5xcctl nginx delete nginx_csg <name> -n <namespace>
```
