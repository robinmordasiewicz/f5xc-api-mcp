...
```bash
# Create/Update
f5xcctl nginx create nginx_instance -n <namespace> -i nginx_instance.yaml

# Get
f5xcctl nginx get nginx_instance <name> -n <namespace>

# List
f5xcctl nginx list nginx_instance -n <namespace>

# Delete
f5xcctl nginx delete nginx_instance <name> -n <namespace>
```
