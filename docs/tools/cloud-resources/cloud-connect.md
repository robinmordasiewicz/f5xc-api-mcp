...
```bash
# Create/Update
f5xcctl apply -f cloud_connect.yaml

# Get
f5xcctl get cloud_connect {name} -n {namespace}

# List
f5xcctl get cloud_connects -n {namespace}

# Delete
f5xcctl delete cloud_connect {name} -n {namespace}
```
