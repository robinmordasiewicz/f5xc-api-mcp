...
```bash
# Create/Update
f5xcctl operations create escalate -n <namespace> -i escalate.yaml

# Get
f5xcctl operations get escalate <name> -n <namespace>

# List
f5xcctl operations list escalate -n <namespace>

# Delete
f5xcctl operations delete escalate <name> -n <namespace>
```
