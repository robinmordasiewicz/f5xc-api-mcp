...
```bash
# Create/Update
f5xcctl apply -f tls_summary.yaml

# Get
f5xcctl get tls_summary {name} -n {namespace}

# List
f5xcctl get tls_summarys -n {namespace}

# Delete
f5xcctl delete tls_summary {name} -n {namespace}
```
