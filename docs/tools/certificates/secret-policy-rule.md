...
```bash
# Create/Update
f5xcctl apply -f secret_policy_rule.yaml

# Get
f5xcctl get secret_policy_rule {name} -n {namespace}

# List
f5xcctl get secret_policy_rules -n {namespace}

# Delete
f5xcctl delete secret_policy_rule {name} -n {namespace}
```
