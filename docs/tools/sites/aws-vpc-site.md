...
```bash
# Create/Update
f5xcctl apply -f aws_vpc_site.yaml

# Get
f5xcctl get aws_vpc_site {name} -n {namespace}

# List
f5xcctl get aws_vpc_sites -n {namespace}

# Delete
f5xcctl delete aws_vpc_site {name} -n {namespace}
```
