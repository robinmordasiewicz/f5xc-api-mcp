...
```bash
# Create/Update
xcsh sites create virtual_k8s -n <namespace> -i virtual_k8s.yaml

# Get
xcsh sites get virtual_k8s <name> -n <namespace>

# List
xcsh sites list virtual_k8s -n <namespace>

# Delete
xcsh sites delete virtual_k8s <name> -n <namespace>
```
