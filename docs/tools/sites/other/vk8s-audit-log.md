...
```bash
# Create/Update
f5xcctl sites create vk8s_audit_log -n <namespace> -i vk8s_audit_log.yaml

# Get
f5xcctl sites get vk8s_audit_log <name> -n <namespace>

# List
f5xcctl sites list vk8s_audit_log -n <namespace>

# Delete
f5xcctl sites delete vk8s_audit_log <name> -n <namespace>
```
