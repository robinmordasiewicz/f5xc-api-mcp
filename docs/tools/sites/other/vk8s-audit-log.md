...
```bash
# Create/Update
xcsh sites create vk8s_audit_log -n <namespace> -i vk8s_audit_log.yaml

# Get
xcsh sites get vk8s_audit_log <name> -n <namespace>

# List
xcsh sites list vk8s_audit_log -n <namespace>

# Delete
xcsh sites delete vk8s_audit_log <name> -n <namespace>
```
