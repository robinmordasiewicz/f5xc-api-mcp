...
```bash
# Create/Update
f5xcctl sites create vk8s_event -n <namespace> -i vk8s_event.yaml

# Get
f5xcctl sites get vk8s_event <name> -n <namespace>

# List
f5xcctl sites list vk8s_event -n <namespace>

# Delete
f5xcctl sites delete vk8s_event <name> -n <namespace>
```
