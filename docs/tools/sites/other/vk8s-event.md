...
```bash
# Create/Update
xcsh sites create vk8s_event -n <namespace> -i vk8s_event.yaml

# Get
xcsh sites get vk8s_event <name> -n <namespace>

# List
xcsh sites list vk8s_event -n <namespace>

# Delete
xcsh sites delete vk8s_event <name> -n <namespace>
```
