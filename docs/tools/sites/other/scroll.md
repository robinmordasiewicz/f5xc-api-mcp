...
```bash
# Create/Update
f5xcctl sites create scroll -n <namespace> -i scroll.yaml

# Get
f5xcctl sites get scroll <name> -n <namespace>

# List
f5xcctl sites list scroll -n <namespace>

# Delete
f5xcctl sites delete scroll <name> -n <namespace>
```
