...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-protocol-policer-create` | Create Protocol Policer |
| `f5xc-api-core-protocol-policer-get` | Get Protocol Policer |
| `f5xc-api-core-protocol-policer-list` | List Protocol Policer |
| `f5xc-api-core-protocol-policer-update` | Replace Protocol Policer |
| `f5xc-api-core-protocol-policer-delete` | Delete Protocol Policer |
