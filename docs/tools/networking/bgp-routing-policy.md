...
```bash
# Create/Update
f5xcctl apply -f bgp_routing_policy.yaml

# Get
f5xcctl get bgp_routing_policy {name} -n {namespace}

# List
f5xcctl get bgp_routing_policys -n {namespace}

# Delete
f5xcctl delete bgp_routing_policy {name} -n {namespace}
```
