...
```bash
# Create/Update
f5xcctl networking create get_dns_info -n <namespace> -i get_dns_info.yaml

# Get
f5xcctl networking get get_dns_info <name> -n <namespace>

# List
f5xcctl networking list get_dns_info -n <namespace>

# Delete
f5xcctl networking delete get_dns_info <name> -n <namespace>
```
