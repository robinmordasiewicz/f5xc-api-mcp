...
```bash
# Create/Update
f5xcctl networking create bgp -n <namespace> -i bgp.yaml

# Get
f5xcctl networking get bgp <name> -n <namespace>

# List
f5xcctl networking list bgp -n <namespace>

# Delete
f5xcctl networking delete bgp <name> -n <namespace>
```
