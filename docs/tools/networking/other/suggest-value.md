...
| Tool | Description |
|------|-------------|
| `f5xc-api-networking-suggest-value-create` | Suggest Values. |
...
```bash
# Create/Update
f5xcctl networking create suggest_value -n <namespace> -i suggest_value.yaml

# Get
f5xcctl networking get suggest_value <name> -n <namespace>

# List
f5xcctl networking list suggest_value -n <namespace>

# Delete
f5xcctl networking delete suggest_value <name> -n <namespace>
```
