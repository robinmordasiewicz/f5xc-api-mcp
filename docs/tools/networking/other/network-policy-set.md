...
| Tool | Description |
|------|-------------|
| `f5xc-api-networking-network-policy-set-get` | GET Network Policy Set. |
| `f5xc-api-networking-network-policy-set-list` | List Network Policy Set. |
...
```bash
# Create/Update
f5xcctl networking create network_policy_set -n <namespace> -i network_policy_set.yaml

# Get
f5xcctl networking get network_policy_set <name> -n <namespace>

# List
f5xcctl networking list network_policy_set -n <namespace>

# Delete
f5xcctl networking delete network_policy_set <name> -n <namespace>
```
