...
```bash
# Create/Update
f5xcctl apply -f active_network_policie.yaml

# Get
f5xcctl get active_network_policie {name} -n {namespace}

# List
f5xcctl get active_network_policies -n {namespace}

# Delete
f5xcctl delete active_network_policie {name} -n {namespace}
```
