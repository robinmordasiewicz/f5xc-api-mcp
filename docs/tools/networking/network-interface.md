...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-network-interface-create` | Create Network Interface |
| `f5xc-api-core-network-interface-get` | Get Network Interface |
| `f5xc-api-core-network-interface-list` | List Network Interface |
| `f5xc-api-core-network-interface-update` | Replace Network Interface |
| `f5xc-api-core-network-interface-delete` | Delete Network Interface |
...
```bash
# Create/Update
f5xcctl apply -f network_interface.yaml

# Get
f5xcctl get network_interface {name} -n {namespace}

# List
f5xcctl get network_interfaces -n {namespace}

# Delete
f5xcctl delete network_interface {name} -n {namespace}
```
