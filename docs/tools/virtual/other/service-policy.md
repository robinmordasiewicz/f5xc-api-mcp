...
```bash
# Create/Update
f5xcctl virtual create service_policy -n <namespace> -i service_policy.yaml

# Get
f5xcctl virtual get service_policy <name> -n <namespace>

# List
f5xcctl virtual list service_policy -n <namespace>

# Delete
f5xcctl virtual delete service_policy <name> -n <namespace>
```
