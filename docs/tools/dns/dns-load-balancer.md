...
```bash
# Create/Update
f5xcctl apply -f dns_load_balancer.yaml

# Get
f5xcctl get dns_load_balancer {name} -n {namespace}

# List
f5xcctl get dns_load_balancers -n {namespace}

# Delete
f5xcctl delete dns_load_balancer {name} -n {namespace}
```
