...
```bash
# Create/Update
xcsh dns create suggest_value -n <namespace> -i suggest_value.yaml

# Get
xcsh dns get suggest_value <name> -n <namespace>

# List
xcsh dns list suggest_value -n <namespace>

# Delete
xcsh dns delete suggest_value <name> -n <namespace>
```
