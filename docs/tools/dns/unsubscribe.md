...
```bash
# Create/Update
xcsh dns create unsubscribe -n <namespace> -i unsubscribe.yaml

# Get
xcsh dns get unsubscribe <name> -n <namespace>

# List
xcsh dns list unsubscribe -n <namespace>

# Delete
xcsh dns delete unsubscribe <name> -n <namespace>
```
