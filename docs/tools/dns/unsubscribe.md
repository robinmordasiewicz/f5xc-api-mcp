...
```bash
# Create/Update
f5xcctl dns create unsubscribe -n <namespace> -i unsubscribe.yaml

# Get
f5xcctl dns get unsubscribe <name> -n <namespace>

# List
f5xcctl dns list unsubscribe -n <namespace>

# Delete
f5xcctl dns delete unsubscribe <name> -n <namespace>
```
