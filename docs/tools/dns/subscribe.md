...
```bash
# Create/Update
xcsh dns create subscribe -n <namespace> -i subscribe.yaml

# Get
xcsh dns get subscribe <name> -n <namespace>

# List
xcsh dns list subscribe -n <namespace>

# Delete
xcsh dns delete subscribe <name> -n <namespace>
```
