...
| Tool | Description |
|------|-------------|
| `f5xc-api-identity-service-credential-create` | Bulk Revoke service credential. |
| `f5xc-api-identity-service-credential-get` | GET Service Credential. |
| `f5xc-api-identity-service-credential-list` | List service credentials. |
| `f5xc-api-identity-service-credential-update` | Replace service credentials. |
