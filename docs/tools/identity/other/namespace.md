...
| Tool | Description |
|------|-------------|
| `f5xc-api-identity-namespace-create` | Create Namespace. |
| `f5xc-api-identity-namespace-get` | GET Namespace. |
| `f5xc-api-identity-namespace-list` | List Namespace. |
| `f5xc-api-identity-namespace-update` | Replace Namespace. |
