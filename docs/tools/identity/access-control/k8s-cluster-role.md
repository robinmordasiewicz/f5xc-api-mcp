...
| Tool | Description |
|------|-------------|
| `f5xc-api-identity-k8s-cluster-role-create` | Create Configuration Specification. |
| `f5xc-api-identity-k8s-cluster-role-get` | GET Configuration Specification. |
| `f5xc-api-identity-k8s-cluster-role-list` | List K8s Cluster Role. |
| `f5xc-api-identity-k8s-cluster-role-update` | Replace Configuration Specification. |
| `f5xc-api-identity-k8s-cluster-role-delete` | DELETE K8s Cluster Role. |
...
```bash
# Create/Update
f5xcctl identity create k8s_cluster_role -n <namespace> -i k8s_cluster_role.yaml

# Get
f5xcctl identity get k8s_cluster_role <name> -n <namespace>

# List
f5xcctl identity list k8s_cluster_role -n <namespace>

# Delete
f5xcctl identity delete k8s_cluster_role <name> -n <namespace>
```
