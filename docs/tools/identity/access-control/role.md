...
```bash
# Create/Update
f5xcctl identity create role -n <namespace> -i role.yaml

# Get
f5xcctl identity get role <name> -n <namespace>

# List
f5xcctl identity list role -n <namespace>

# Delete
f5xcctl identity delete role <name> -n <namespace>
```
