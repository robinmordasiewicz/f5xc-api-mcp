...
| Tool | Description |
|------|-------------|
| `f5xc-api-identity-user-group-create` | Create User Group. |
| `f5xc-api-identity-user-group-get` | Fetch all the details for a group provided the group ID. |
| `f5xc-api-identity-user-group-list` | GET all User Groups for the tenant. |
| `f5xc-api-identity-user-group-update` | Replace the User Group fields / accesses / associations. |
| `f5xc-api-identity-user-group-delete` | DELETE a group provided the group ID. |
...
```bash
# Create/Update
f5xcctl identity create user_group -n <namespace> -i user_group.yaml

# Get
f5xcctl identity get user_group <name> -n <namespace>

# List
f5xcctl identity list user_group -n <namespace>

# Delete
f5xcctl identity delete user_group <name> -n <namespace>
```
