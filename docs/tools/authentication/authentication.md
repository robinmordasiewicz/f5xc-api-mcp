...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-authentication-create` | Create Authentication |
| `f5xc-api-core-authentication-get` | Get Authentication |
| `f5xc-api-core-authentication-list` | List Authentication |
| `f5xc-api-core-authentication-update` | Replace Authentication |
| `f5xc-api-core-authentication-delete` | Delete Authentication |
