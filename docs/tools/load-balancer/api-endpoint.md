...
```bash
# Create/Update
f5xcctl load_balancer create api_endpoint -n <namespace> -i api_endpoint.yaml

# Get
f5xcctl load_balancer get api_endpoint <name> -n <namespace>

# List
f5xcctl load_balancer list api_endpoint -n <namespace>

# Delete
f5xcctl load_balancer delete api_endpoint <name> -n <namespace>
```
