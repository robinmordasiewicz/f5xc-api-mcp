...
```bash
# Create/Update
f5xcctl load_balancer create get_service_operation_statu -n <namespace> -i get_service_operation_statu.yaml

# Get
f5xcctl load_balancer get get_service_operation_statu <name> -n <namespace>

# List
f5xcctl load_balancer list get_service_operation_statu -n <namespace>

# Delete
f5xcctl load_balancer delete get_service_operation_statu <name> -n <namespace>
```
