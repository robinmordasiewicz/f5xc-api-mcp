...
```bash
# Create/Update
f5xcctl load_balancer create l7ddos_rps_threshold -n <namespace> -i l7ddos_rps_threshold.yaml

# Get
f5xcctl load_balancer get l7ddos_rps_threshold <name> -n <namespace>

# List
f5xcctl load_balancer list l7ddos_rps_threshold -n <namespace>

# Delete
f5xcctl load_balancer delete l7ddos_rps_threshold <name> -n <namespace>
```
