...
| Tool | Description |
|------|-------------|
| `f5xc-api-loadbalancer-get-security-config-create` | GET Security Config for HTTP Load Balancer. |
...
```bash
# Create/Update
f5xcctl load_balancer create get_security_config -n <namespace> -i get_security_config.yaml

# Get
f5xcctl load_balancer get get_security_config <name> -n <namespace>

# List
f5xcctl load_balancer list get_security_config -n <namespace>

# Delete
f5xcctl load_balancer delete get_security_config <name> -n <namespace>
```
