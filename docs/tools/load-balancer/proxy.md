...
| Tool | Description |
|------|-------------|
| `f5xc-api-loadbalancer-proxy-create` | Create Proxy. |
| `f5xc-api-loadbalancer-proxy-get` | GET Proxy |
| `f5xc-api-loadbalancer-proxy-list` | List Proxy. |
| `f5xc-api-loadbalancer-proxy-update` | Replace Proxy. |
| `f5xc-api-loadbalancer-proxy-delete` | DELETE Proxy. |
