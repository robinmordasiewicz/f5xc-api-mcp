...
| Tool | Description |
|------|-------------|
| `f5xc-api-loadbalancer-dos-automitigation-rule-get` | GET DoS Auto-Mitigation Rules for HTTP Load Balancer. |
| `f5xc-api-loadbalancer-dos-automitigation-rule-delete` | DELETE DoS Auto-Mitigation Rule for HTTP Load Balancer. |
