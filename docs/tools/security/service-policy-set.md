...
```bash
# Create/Update
f5xcctl apply -f service_policy_set.yaml

# Get
f5xcctl get service_policy_set {name} -n {namespace}

# List
f5xcctl get service_policy_sets -n {namespace}

# Delete
f5xcctl delete service_policy_set {name} -n {namespace}
```
