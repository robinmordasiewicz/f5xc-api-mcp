...
```bash
# Create/Update
f5xcctl apply -f released_signature.yaml

# Get
f5xcctl get released_signature {name} -n {namespace}

# List
f5xcctl get released_signatures -n {namespace}

# Delete
f5xcctl delete released_signature {name} -n {namespace}
```
