...
```bash
# Create/Update
f5xcctl security create event -n <namespace> -i event.yaml

# Get
f5xcctl security get event <name> -n <namespace>

# List
f5xcctl security list event -n <namespace>

# Delete
f5xcctl security delete event <name> -n <namespace>
```
