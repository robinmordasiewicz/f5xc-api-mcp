...
| Tool | Description |
|------|-------------|
| `f5xc-api-security-crl-create` | Create CRL. |
| `f5xc-api-security-crl-get` | GET CRL |
| `f5xc-api-security-crl-list` | List CRL |
| `f5xc-api-security-crl-update` | Replace CRL. |
| `f5xc-api-security-crl-delete` | DELETE CRL. |
