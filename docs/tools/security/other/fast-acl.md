...
```bash
# Create/Update
f5xcctl security create fast_acl -n <namespace> -i fast_acl.yaml

# Get
f5xcctl security get fast_acl <name> -n <namespace>

# List
f5xcctl security list fast_acl -n <namespace>

# Delete
f5xcctl security delete fast_acl <name> -n <namespace>
```
