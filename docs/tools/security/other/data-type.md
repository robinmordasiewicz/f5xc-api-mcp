...
| Tool | Description |
|------|-------------|
| `f5xc-api-security-data-type-create` | Create Data Type. |
| `f5xc-api-security-data-type-get` | GET Data Type. |
| `f5xc-api-security-data-type-list` | List Data Type. |
| `f5xc-api-security-data-type-update` | Replace Data Type. |
| `f5xc-api-security-data-type-delete` | DELETE Data Type. |
