...
| Tool | Description |
|------|-------------|
| `f5xc-api-waap-rate-limiter-create` | Create Rate Limiter |
| `f5xc-api-waap-rate-limiter-get` | Get Rate Limiter |
| `f5xc-api-waap-rate-limiter-list` | List Rate Limiter |
| `f5xc-api-waap-rate-limiter-update` | Replace Rate Limiter |
...
```bash
# Create/Update
f5xcctl configuration create rate_limiter -n <namespace> -i rate_limiter.yaml

# Get
f5xcctl configuration get rate_limiter -n <namespace> <name>

# List
f5xcctl configuration list rate_limiter -n <namespace>

# Delete
f5xcctl configuration delete rate_limiter -n <namespace> <name>
```
