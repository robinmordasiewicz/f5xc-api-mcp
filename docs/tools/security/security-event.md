...
```bash
# Create/Update
f5xcctl apply -f security_event.yaml

# Get
f5xcctl get security_event {name} -n {namespace}

# List
f5xcctl get security_events -n {namespace}

# Delete
f5xcctl delete security_event {name} -n {namespace}
```
