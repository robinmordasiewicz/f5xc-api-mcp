...
```bash
# Create/Update
f5xcctl security create latency -n <namespace> -i latency.yaml

# Get
f5xcctl security get latency <name> -n <namespace>

# List
f5xcctl security list latency -n <namespace>

# Delete
f5xcctl security delete latency <name> -n <namespace>
```
