...
| Tool | Description |
|------|-------------|
| `f5xc-api-security-secret-policy-create` | Create Secret Policy. |
| `f5xc-api-security-secret-policy-get` | GET Secret Policy. |
| `f5xc-api-security-secret-policy-list` | List Secret Policy. |
| `f5xc-api-security-secret-policy-update` | Replace Secret Policy. |
| `f5xc-api-security-secret-policy-delete` | DELETE Secret Policy. |
