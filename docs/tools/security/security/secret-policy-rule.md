...
| Tool | Description |
|------|-------------|
| `f5xc-api-security-secret-policy-rule-create` | Create Secret Policy Rule. |
| `f5xc-api-security-secret-policy-rule-get` | GET Secret Policy Rule. |
| `f5xc-api-security-secret-policy-rule-list` | List Secret Policy Rule. |
| `f5xc-api-security-secret-policy-rule-update` | Replace Secret Policy Rule. |
| `f5xc-api-security-secret-policy-rule-delete` | DELETE Secret Policy Rule. |
...
```bash
# Create/Update
f5xcctl security create secret_policy_rule -n <namespace> -i secret_policy_rule.yaml

# Get
f5xcctl security get secret_policy_rule <name> -n <namespace>

# List
f5xcctl security list secret_policy_rule -n <namespace>

# Delete
f5xcctl security delete secret_policy_rule <name> -n <namespace>
```
