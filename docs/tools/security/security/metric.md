...
```bash
# Create/Update
f5xcctl security create metric -n <namespace> -i metric.yaml

# Get
f5xcctl security get metric <name> -n <namespace>

# List
f5xcctl security list metric -n <namespace>

# Delete
f5xcctl security delete metric <name> -n <namespace>
```
