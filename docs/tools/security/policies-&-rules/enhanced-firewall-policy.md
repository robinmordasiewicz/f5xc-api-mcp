...
| Tool | Description |
|------|-------------|
| `f5xc-api-security-enhanced-firewall-policy-create` | Create Enhanced Firewall Policy. |
| `f5xc-api-security-enhanced-firewall-policy-get` | GET Enhanced Firewall Policy. |
| `f5xc-api-security-enhanced-firewall-policy-list` | List Enhanced Firewall Policy. |
| `f5xc-api-security-enhanced-firewall-policy-update` | Replace Enhanced Firewall Policy. |
| `f5xc-api-security-enhanced-firewall-policy-delete` | DELETE Enhanced Firewall Policy. |
