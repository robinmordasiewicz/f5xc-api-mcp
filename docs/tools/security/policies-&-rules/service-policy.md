...
```bash
# Create/Update
f5xcctl security create service_policy -n <namespace> -i service_policy.yaml

# Get
f5xcctl security get service_policy <name> -n <namespace>

# List
f5xcctl security list service_policy -n <namespace>

# Delete
f5xcctl security delete service_policy <name> -n <namespace>
```
