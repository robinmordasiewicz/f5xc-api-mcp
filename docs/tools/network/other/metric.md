...
```bash
# Create/Update
f5xcctl network create metric -n <namespace> -i metric.yaml

# Get
f5xcctl network get metric <name> -n <namespace>

# List
f5xcctl network list metric -n <namespace>

# Delete
f5xcctl network delete metric <name> -n <namespace>
```
