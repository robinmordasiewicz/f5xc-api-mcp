...
```bash
# Create/Update
xcsh network create metric -n <namespace> -i metric.yaml

# Get
xcsh network get metric <name> -n <namespace>

# List
xcsh network list metric -n <namespace>

# Delete
xcsh network delete metric <name> -n <namespace>
```
