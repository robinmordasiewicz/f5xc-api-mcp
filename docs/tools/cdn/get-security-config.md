...
```bash
# Create/Update
xcsh cdn create get_security_config -n <namespace> -i get_security_config.yaml

# Get
xcsh cdn get get_security_config <name> -n <namespace>

# List
xcsh cdn list get_security_config -n <namespace>

# Delete
xcsh cdn delete get_security_config <name> -n <namespace>
```
