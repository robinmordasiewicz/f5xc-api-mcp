...
```bash
# Create/Update
xcsh cdn create dos_automitigation_rule -n <namespace> -i dos_automitigation_rule.yaml

# Get
xcsh cdn get dos_automitigation_rule <name> -n <namespace>

# List
xcsh cdn list dos_automitigation_rule -n <namespace>

# Delete
xcsh cdn delete dos_automitigation_rule <name> -n <namespace>
```
