...
```bash
# Create/Update
xcsh tenant_and_identity create evaluate_batch_api_acces -n <namespace> -i evaluate_batch_api_acces.yaml

# Get
xcsh tenant_and_identity get evaluate_batch_api_acces <name> -n <namespace>

# List
xcsh tenant_and_identity list evaluate_batch_api_acces -n <namespace>

# Delete
xcsh tenant_and_identity delete evaluate_batch_api_acces <name> -n <namespace>
```
