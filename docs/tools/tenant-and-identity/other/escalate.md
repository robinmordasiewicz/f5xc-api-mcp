...
```bash
# Create/Update
xcsh tenant_and_identity create escalate -n <namespace> -i escalate.yaml

# Get
xcsh tenant_and_identity get escalate <name> -n <namespace>

# List
xcsh tenant_and_identity list escalate -n <namespace>

# Delete
xcsh tenant_and_identity delete escalate <name> -n <namespace>
```
