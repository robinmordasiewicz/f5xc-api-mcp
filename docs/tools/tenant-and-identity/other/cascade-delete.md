...
```bash
# Create/Update
xcsh tenant_and_identity create cascade_delete -n <namespace> -i cascade_delete.yaml

# Get
xcsh tenant_and_identity get cascade_delete <name> -n <namespace>

# List
xcsh tenant_and_identity list cascade_delete -n <namespace>

# Delete
xcsh tenant_and_identity delete cascade_delete <name> -n <namespace>
```
