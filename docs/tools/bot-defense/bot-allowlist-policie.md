...
```bash
# Create/Update
f5xcctl apply -f bot_allowlist_policie.yaml

# Get
f5xcctl get bot_allowlist_policie {name} -n {namespace}

# List
f5xcctl get bot_allowlist_policies -n {namespace}

# Delete
f5xcctl delete bot_allowlist_policie {name} -n {namespace}
```
