...
| Tool | Description |
|------|-------------|
| `f5xc-api-core-bot-defense-app-infrastructure-create` | Create Bot Defense App Infrastructure |
| `f5xc-api-core-bot-defense-app-infrastructure-get` | Bot Defense App Infrastructure |
| `f5xc-api-core-bot-defense-app-infrastructure-list` | List Bot Defense App Infrastructure |
| `f5xc-api-core-bot-defense-app-infrastructure-update` | Replace Bot Defense App Infrastructure |
| `f5xc-api-core-bot-defense-app-infrastructure-delete` | Delete Bot Defense App Infrastructure |
...
```bash
# Create/Update
f5xcctl apply -f bot_defense_app_infrastructure.yaml

# Get
f5xcctl get bot_defense_app_infrastructure {name} -n {namespace}

# List
f5xcctl get bot_defense_app_infrastructures -n {namespace}

# Delete
f5xcctl delete bot_defense_app_infrastructure {name} -n {namespace}
```
