...
| Tool | Description |
|------|-------------|
| `f5xc-api-apisecurity-sensitive-data-policy-create` | Create Sensitive Data Discovery. |
| `f5xc-api-apisecurity-sensitive-data-policy-get` | GET Sensitive Data Discovery. |
| `f5xc-api-apisecurity-sensitive-data-policy-list` | List Sensitive Data Discovery. |
| `f5xc-api-apisecurity-sensitive-data-policy-update` | Replace Sensitive Data Discovery. |
| `f5xc-api-apisecurity-sensitive-data-policy-delete` | DELETE Sensitive Data Discovery. |
