...
```bash
# Create/Update
f5xcctl apply -f api_discovery.yaml

# Get
f5xcctl get api_discovery {name} -n {namespace}

# List
f5xcctl get api_discoverys -n {namespace}

# Delete
f5xcctl delete api_discovery {name} -n {namespace}
```
