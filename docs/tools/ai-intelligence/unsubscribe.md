...
| Tool | Description |
|------|-------------|
| `f5xc-api-aiintelligence-unsubscribe-create` | Unsubscribe to BFDP pipeline. |
...
```bash
# Create/Update
f5xcctl ai_intelligence create unsubscribe -n <namespace> -i unsubscribe.yaml

# Get
f5xcctl ai_intelligence get unsubscribe <name> -n <namespace>

# List
f5xcctl ai_intelligence list unsubscribe -n <namespace>

# Delete
f5xcctl ai_intelligence delete unsubscribe <name> -n <namespace>
```
