...
| Tool | Description |
|------|-------------|
| `f5xc-api-infrastructure-aws-vpc-site-create` | Create AWS VPC site. |
| `f5xc-api-infrastructure-aws-vpc-site-get` | GET AWS VPC site. |
| `f5xc-api-infrastructure-aws-vpc-site-list` | List Configure AWS VPC Site. |
| `f5xc-api-infrastructure-aws-vpc-site-update` | Replace AWS VPC site. |
| `f5xc-api-infrastructure-aws-vpc-site-delete` | DELETE Configure AWS VPC Site. |
