...
```bash
# Create/Update
f5xcctl infrastructure create gcp_vpc_site -n <namespace> -i gcp_vpc_site.yaml

# Get
f5xcctl infrastructure get gcp_vpc_site <name> -n <namespace>

# List
f5xcctl infrastructure list gcp_vpc_site -n <namespace>

# Delete
f5xcctl infrastructure delete gcp_vpc_site <name> -n <namespace>
```
