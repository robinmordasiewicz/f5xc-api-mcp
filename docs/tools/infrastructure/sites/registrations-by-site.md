...
```bash
# Create/Update
f5xcctl infrastructure create registrations_by_site -n <namespace> -i registrations_by_site.yaml

# Get
f5xcctl infrastructure get registrations_by_site <name> -n <namespace>

# List
f5xcctl infrastructure list registrations_by_site -n <namespace>

# Delete
f5xcctl infrastructure delete registrations_by_site <name> -n <namespace>
```
