...
| Tool | Description |
|------|-------------|
| `f5xc-api-infrastructure-suggest-value-create` | Suggest Values. |
...
```bash
# Create/Update
f5xcctl infrastructure create suggest_value -n <namespace> -i suggest_value.yaml

# Get
f5xcctl infrastructure get suggest_value <name> -n <namespace>

# List
f5xcctl infrastructure list suggest_value -n <namespace>

# Delete
f5xcctl infrastructure delete suggest_value <name> -n <namespace>
```
