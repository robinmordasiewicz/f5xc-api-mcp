...
| Tool | Description |
|------|-------------|
| `f5xc-api-infrastructure-k8s-pod-security-admission-create` | Create Configuration Specification. |
| `f5xc-api-infrastructure-k8s-pod-security-admission-get` | GET Configuration Specification. |
| `f5xc-api-infrastructure-k8s-pod-security-admission-list` | List K8s Pod Security Admission. |
| `f5xc-api-infrastructure-k8s-pod-security-admission-update` | Replace Configuration Specification. |
| `f5xc-api-infrastructure-k8s-pod-security-admission-delete` | DELETE K8s Pod Security Admission. |
