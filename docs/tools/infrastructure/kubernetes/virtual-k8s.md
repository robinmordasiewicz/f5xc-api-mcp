...
```bash
# Create/Update
f5xcctl infrastructure create virtual_k8s -n <namespace> -i virtual_k8s.yaml

# Get
f5xcctl infrastructure get virtual_k8s <name> -n <namespace>

# List
f5xcctl infrastructure list virtual_k8s -n <namespace>

# Delete
f5xcctl infrastructure delete virtual_k8s <name> -n <namespace>
```
