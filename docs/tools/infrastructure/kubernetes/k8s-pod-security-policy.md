...
| Tool | Description |
|------|-------------|
| `f5xc-api-infrastructure-k8s-pod-security-policy-create` | Create Configuration Specification. |
| `f5xc-api-infrastructure-k8s-pod-security-policy-get` | GET Configuration Specification. |
| `f5xc-api-infrastructure-k8s-pod-security-policy-list` | List K8s Pod Security Policy. |
| `f5xc-api-infrastructure-k8s-pod-security-policy-update` | Replace Configuration Specification. |
| `f5xc-api-infrastructure-k8s-pod-security-policy-delete` | DELETE K8s Pod Security Policy. |
