...
| Tool | Description |
|------|-------------|
| `f5xc-api-infrastructure-set-cloud-site-info-create` | Configure AWS VPC Site Information. |
...
```bash
# Create/Update
f5xcctl infrastructure create set_cloud_site_info -n <namespace> -i set_cloud_site_info.yaml

# Get
f5xcctl infrastructure get set_cloud_site_info <name> -n <namespace>

# List
f5xcctl infrastructure list set_cloud_site_info -n <namespace>

# Delete
f5xcctl infrastructure delete set_cloud_site_info <name> -n <namespace>
```
